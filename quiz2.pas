...
qaList = [QA("Where is London?", "in England", ["in Greece", "such a city doesn't exist"]),
QA("What is the capital of France?", "Paris", ["Sydney", "New York", "France doesn't exist"]),
QA("Which of the following is not a car constructor?", "Apple", ["BMW", "Volvo", "Peugeot"]),
QA("Which of the following is not a car constructor?", "Intel", ["Mercedes", "BMW"]),
QA("Which of the following is not a European country?", "Morocco", ["Greece", "Germany", "Italy", "England"])]
